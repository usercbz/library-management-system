...
public class RedisConst {
    ...
    public static final String QUERY_BOOK_KEY_PRE = "query:book:";
    public static final Long QUERY_BOOK_TTL = 1L;

    public static final String QUERY_BOOKS_KEY_PRE = "query:books:";
    public static final Long QUERY_BOOKS_TTL = 4L;
